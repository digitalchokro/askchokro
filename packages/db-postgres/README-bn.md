...
> **নোট:** AskChokro আপাতত শুধুমাত্র সিঙ্গেল-স্টেটমেন্ট SQL অ্যালাও করে। অর্থাৎ, AI কে বলে দেওয়া হয়েছে প্রতিবার সে ঠিক একটাই `SELECT` স্টেটমেন্ট তৈরি করবে। 
...
- **শুধুমাত্র সিঙ্গেল স্টেটমেন্ট:** জটিল কোনো স্ক্রিপ্ট ইনজেকশন আটকাতে ইঞ্জিনটি প্রতি রিকোয়েস্টে ঠিক একটি `SELECT` স্টেটমেন্ট বাধ্যতামূলক করে।
